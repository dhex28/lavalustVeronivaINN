...
class Welcome extends Controller {
	...
	public function addroompage() {
		$data = $this->Crud_model->read();
		$this->call->view('admin/add-room', $data);
	}

	public function allbooking() {
		$data = $this->Crud_model->readBook();
		$this->call->view('admin/all-booking', $data);
	}
...
public function roomread(){
	$data = $this->Crud_model->read();
	$this->call->view('user/roompage', $data);
